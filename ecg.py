...
def load_ecg_data():
    ...
    try:
        ...
        print("Data loaded successfully:", data.head())  # Debugging: Print the first few rows of the data
        return data['ECG'].values.astype(float)  # Assuming 'ECG' is the column containing ECG data
...
def calculate_heart_rate(ecg_data, sampling_rate=500):
    ...
    print("Heart rates calculated:", heart_rates)  # Debugging: Print the calculated heart rates
...
def show_help():
    help_text = (
        ...
        "5. Click 'Help' to display this help information again.\n"
    )
